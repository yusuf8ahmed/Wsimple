...
class Wsimple:
    ...
    #? function make_deposit(self, amount: int, currency: str = "CAD", bank_account_id: str = None, account_id: str = None):
    ...
    #? function get_deposit(self, funds_transfer_id: str):
    ...
    #? function list_deposits(self): 
    Get all deposits under this WealthSimple Trade account.  
    
    #? function delete_deposit(self, funds_transfer_id: str):
