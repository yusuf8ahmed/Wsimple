...
class Endpoints(Enum):
    ...
    LOGIN = Route("{base}auth/login", "GET")
    REFRESH = Route("{base}auth/refresh", "GET")
    ...
    GET_SECURITIES_IN_GROUPS = Route("{base}security-groups/{group_id}/securities", "GET")
    ...
    GET_SUPPORTED_INTERNAL_TRANSFERS = Route("{base}supported-internal-transfers", "GET")
    ...
    GET_URL_MONTHLY_STATEMENTS = Route("{base}monthly-statements/{pdf_statement_id}", "GET")
